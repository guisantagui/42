...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/04/11 22:56:32 by gsantama          #+#    #+#             */
/*   Updated: 2025/04/11 23:00:45 by gsantama         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "fractol.h"

static void	newton_calcs_three(double z_re, double z_im,
				double *diff_re, double *diff_im)
{
	double	f_re;
	double	f_im;
	double	df_re;
...
static void	newton_calcs_cosh(double z_re, double z_im,
				double *diff_re, double *diff_im)
{
	double	f_re;
	double	f_im;
